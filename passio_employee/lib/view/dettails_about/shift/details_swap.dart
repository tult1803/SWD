...
class DetailsSwap extends StatefulWidget {
  ...
  DetailsSwap({Key key, this.dataGetByDate}) : super(key: key);

  @override
  _DetailsSwapState createState() => _DetailsSwapState(dataGetByDate);
}
...
class _DetailsSwapState extends State<DetailsSwap> {
  ...
  int employee_id, work_id;

  _DetailsSwapState(this.dataGetByDate);
    ...
    await showDialog(
      ...
      builder: (BuildContext context) {
        ...
        return AlertDialog(
          ...
          content: new Text("Chắc chắn đổi ca !!!",
              style: TextStyle(
                color: Colors.black87,
                fontSize: 20,
                fontWeight: FontWeight.w500,
          ...
          actions: <Widget>[
            ...
            new FlatButton(
              ...
              onPressed: () async {
                ...
                int status = await _putSwap.putSwap(token, work_id, employee_id);
                if (status == 200) {
                  print('ID Swap: $work_id - Id Emp: $employee_id');
